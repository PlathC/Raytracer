...
namespace rt
{
    ...
    Environment Environment::RandomEnvironment() {
        ...
        world.Add(std::make_unique<rt::Sphere>(glm::vec3(0, -1000, 0), 1000, std::move(groundMaterial)));
        ...
        world.Add(std::make_unique<rt::Sphere>(glm::vec3(0, 1, 0), 1.0, std::move(material1)));

        auto material2 = std::make_unique<rt::Lambertian>(glm::vec3(0.4, 0.2, 0.1));
        world.Add(std::make_unique<rt::Sphere>(glm::vec3(-4, 1, 0), 1.0, std::move(material2)));

        auto material3 = std::make_unique<rt::Metal>(glm::vec3(0.7, 0.6, 0.5), 0.0);
        world.Add(std::make_unique<rt::Sphere>(glm::vec3(4, 1, 0), 1.0, std::move(material3)));
